...
# Es un archivo generado automáticamente.por la herramienta PLY (Python Lex-Yacc) y contiene las tablas de parsing compiladas
#para el analizador sintactico. Su funcion principal es optimizar el rendimiento del analizador sintactico.

#El analizador léxico: proporciona los tokens que se usan en este archivo
#El analizador sintactico: define las teglas graamticales que PLY compila en las tablas de este archivo
#El Parsertab.py: almacena la version compilada y optimizada de tu gramatica.
_tabversion = '3.10'
...
_lr_action = {}
#define que hacer en cada estado del parse cuando se  encunetra un token especifico:
#shift: avanzar al siguiente estado
#reduce: aplicar una regla gramatical
#accept: aceptar la entrada como válida
#error: manejar un error de sintaxis
...
_lr_goto = {}
#Indica a que estado ir despues de reducir una regla de produccion
...
#Es la lista de las reglas gramaticales del lenguaje, incluyendo: 
